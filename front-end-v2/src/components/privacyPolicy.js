        ...
        <div className={'main'}>
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Allthesubs, accessible from <a
                            href="https://allthesubs.com/"
                            rel="external nofollow noopener"
                            target="_blank">https://allthesubs.com/</a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: allthesubss@gmail.com</li>
                </ul>
            </div>
        </div>
    )
